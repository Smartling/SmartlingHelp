...
Once your source domain is added to Smartling, you can begin to capture and translate source strings. In order to serve translations, however, you will need to set up each of your translated sites. There are several ways you can organize your translated sites, each with their own advantages and disadvantages.
...
* Akamai
  ...
  <br>**4)** Modify path rule `/ Match Criteria /Component Path: /FOLDERNAME/` (Ignore Case)
